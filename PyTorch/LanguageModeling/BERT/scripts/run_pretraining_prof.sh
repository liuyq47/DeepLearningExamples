...
DATA_DIR=/home/ec2-user/pt-bert/NV-data/seq_128_pred_20_dupe_5/training/
...
#CMD="python3 -m cProfile -o n1_g8_p1.prof -m torch.distributed.launch --nproc_per_node=$num_gpus $CMD"
CMD="python3  -m cProfile -o n1_g1_p1.prof -m torch.distributed.launch --nproc_per_node=$num_gpus $CMD"
