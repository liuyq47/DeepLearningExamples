...
export LD_LIBRARY_PATH=$HOME/aws-ofi-nccl/install/lib/:$HOME/nccl/build/lib:/usr/local/cuda-10.0/lib64:/opt/amazon/efa/lib64:$LD_LIBRARY_PATH
...
num_gpus=8
optimizer="neslamb"
warmup_proportion="0.375"
const_proportion="0.3"
train_steps=4248
