...
def train(args, index, model, optimizer, finetune=False):
    ...
    for f_id in range(f_start_id + 1, len(files)):
        ...
        dataset_future = pool.submit(create_pretraining_dataset, data_file, 128,
    ...
    train_dataloader, data_file = dataset_future.result(time=None)
    # Run Validation Loss
